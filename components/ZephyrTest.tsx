...
const ZephyrTest: React.FC<ZephyrTestProps> = ({ testCases, onCreateTest, onUpdateStatus }) => {
  ...
  return (
    <div className="p-12 max-w-7xl mx-auto space-y-12 overflow-y-auto custom-scrollbar h-full bg-slate-50/20">
       <div className="flex justify-between items-end border-b border-slate-100 pb-10">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Scrumer Quality Center</h1>
